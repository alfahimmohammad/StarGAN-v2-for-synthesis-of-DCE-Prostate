...
from core.solver_1 import Solver
...
def create_data_loaders(args):
    ...
    return input_loader , test_loader , ref_loader 
...
#                         help='This argument is used in solver')
    ...
    parser.add_argument('--train_path',type=str,default='/media/Data/MRI/datasets/')
    parser.add_argument('--validation_path',type=str,default='/media/Data/MRI/datasets/')
    parser.add_argument('--acceleration_factor',type=str,default=['4x'])
    parser.add_argument('--dataset_type_1',type=str,default=['mrbrain_t1'])
    parser.add_argument('--dataset_type_2',type=str,default=['mrbrain_flair'])
    parser.add_argument('--mask_type',type=str,default=['cartesian'])
    
    
    parser.add_argument('--sample_dir', type=str, default='directories/sample_dir',
                        help='Directory for saving generated images')
    parser.add_argument('--checkpoint_dir', type=str, default='directories/checkpoint_dir',
                        help='Directory for saving network checkpoints')

    # directory for calculating metrics
    parser.add_argument('--eval_dir', type=str, default='directories/eval_dir',
                        help='Directory for saving metrics, i.e., FID and LPIPS')

    # directory for testing
    parser.add_argument('--result_dir', type=str, default='directories/result_dir',
                        help='Directory for saving generated images and videos')
#     parser.add_argument('--src_dir', type=str, default='assets/representative/celeba_hq/src',
#                         help='Directory containing input source images')
#     parser.add_argument('--ref_dir', type=str, default='assets/representative/celeba_hq/ref',
#                         help='Directory containing input reference images')
    parser.add_argument('--inp_dir', type=str, default='directories/input_dir',
                        help='input directory when aligning faces')
    parser.add_argument('--out_dir', type=str, default='directories/output_dir',
